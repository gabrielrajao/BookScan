...
const circleBtnStyleSmall = ButtonStyle(padding: WidgetStatePropertyAll(EdgeInsets.zero),backgroundColor: WidgetStatePropertyAll(iconColor), fixedSize: WidgetStatePropertyAll(Size(30, 30)), shape: WidgetStatePropertyAll(CircleBorder()), iconSize: WidgetStatePropertyAll(25), iconColor:  WidgetStatePropertyAll(iconColorHighLight));
